 ...
 */
export const buildValidateFromSimpleSchema = (mySchemaObject, contextName) => {
  return (values) => {
    const context = mySchemaObject.namedContext(contextName ? contextName : 'myContext');
...
export default buildValidateFromSimpleSchema;
